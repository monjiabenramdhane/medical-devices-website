          ...
          <div className="text-center">
            ...
            {brand.websiteUrl && (
              <a
                ...
                className="inline-flex items-center mt-6 px-6 py-3 border border-blue-600 text-base font-medium rounded-md text-blue-600 bg-white hover:bg-blue-50 transition-colors"
              >
